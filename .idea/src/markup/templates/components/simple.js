...
templates.components.simple.view = function(opt_data, opt_ignored) {
  var output = '<div id="carousel" class="content__carousel"><button class="content__carousel-arrow previous">\u21E6</button><div class="gallery"><ul class="gallery__images">';
...
templates.components.simple.carouselItem = function(opt_data, opt_ignored) {
  return '<li><div class="gallery__images-item ' + soy.$$escapeHtml(opt_data['class']) + '"></div></li>';
};
if (goog.DEBUG) {
